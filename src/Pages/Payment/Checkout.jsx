        ...
        <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          ...
          <div className="px-4 space-y-5 text-center">
            <p className="text-[17px]">
              ...
              <span className="text-yellow-500 font-bold">1 Month Duration</span>
              . <br />
          ...
          <button
            type="submit"
            className="cursor-pointer bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 absolute bottom-0 w-full text-center py-2 text-xl font-bold rounded-bl-lg rounded-br-lg"
          >
            Buy Now
          </button>
        </div>
