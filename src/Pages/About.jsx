...
export default function About() {
  return (
    <Layout>
      <div className="pl-auto pt-10 flex flex-col text-white">
        {/* heading */}
        <h1 className='text-center  font-bold text-3xl mb-7'>About Us</h1>
        ...
        <div className="carousel m-auto md:w-1/2 my-16">
